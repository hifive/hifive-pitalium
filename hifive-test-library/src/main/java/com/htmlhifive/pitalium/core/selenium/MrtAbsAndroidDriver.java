...
abstract class MrtAbsAndroidDriver extends SplitScreenshotWebDriver {

	private static final Logger LOG = LoggerFactory.getLogger(MrtAbsAndroidDriver.class);
	 ...
	 */
	MrtAbsAndroidDriver(URL remoteAddress, MrtCapabilities capabilities) {
