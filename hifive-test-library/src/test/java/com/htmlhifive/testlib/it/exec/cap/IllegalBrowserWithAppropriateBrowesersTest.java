 ...
 * 実行時は、JVMの引数で<br>
 * -Dcom.htmlhifive.testlib.environmentConfig=com\htmlhifive\test\it\exec\cap\hifiveRunnerConfig_IllegalBrowserTest_3.
 * json<br>
 * を指定すること.
 */
public class IllegalBrowserWithAppropriateBrowesersTest extends MrtTestBase {
