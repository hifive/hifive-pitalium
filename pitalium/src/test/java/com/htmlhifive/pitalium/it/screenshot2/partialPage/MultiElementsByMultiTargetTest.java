...
public class MultiElementsByMultiTargetTest extends PtlItScreenshotTestBase {
	...
	public void byMultipleClassName() throws Exception {
		...
		ScreenshotArgument arg = ScreenshotArgument.builder("s").addNewTargetByClassName("color-column-0")
				.addNewTargetByClassName("color-column-1").addNewTargetByClassName("color-column-2").build();
