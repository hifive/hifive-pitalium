...
public class TakeScrollScreenshotTest extends PtlTestBase {
	private static final String BASE_URL = "http://172.30.249.159/pitalium-test/com/htmlhifive/pitalium/it/screenshot/fullpage/testPartialScrollTest.html";
	...
	/**
	 * frameのスクリーンショットを取得するテスト。<br>
	 * 現在は、ライブラリ内に<body>タグに依存したコードがあるため動作しない。
	 */
	//	@Test
