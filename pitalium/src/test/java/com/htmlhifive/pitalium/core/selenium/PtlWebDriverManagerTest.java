...
public class PtlWebDriverManagerTest {
	...
	public static abstract class BaseClass extends PtlTestBase {
		...
		public BaseClass(String classId) {
		...
		public void test1() throws Exception {
			driverInstanceIds.get(capabilities.getBrowserName()).put(classId + TEST_1, System.identityHashCode(driver));
		}

		@Test
		public void test2() throws Exception {
			driverInstanceIds.get(capabilities.getBrowserName()).put(classId + TEST_2, System.identityHashCode(driver));
		}

	}

	public static final String NO_ANNOTATION_1 = "NO_ANNOTATION_1";
	public static final String NO_ANNOTATION_2 = "NO_ANNOTATION_2";
	public static final String ANNOTATED_ONLY = "ANNOTATED_ONLY";
	public static final String ANNOTATED_USE_CONFIG = "ANNOTATED_USE_CONFIG";
	public static final String ANNOTATED_TEST_CASE = "ANNOTATED_TEST_CASE";
	public static final String ANNOTATED_TEST_CLASS = "ANNOTATED_TEST_CLASS";
	public static final String ANNOTATED_GLOBAL = "ANNOTATED_GLOBAL";
	...
	static Map<String, Map<String, Integer>> driverInstanceIds;
	...
	public void prepare() throws Exception {
		...
		driverInstanceIds = new HashMap<String, Map<String, Integer>>();
		for (PtlCapabilities[] capabilities : PtlCapabilities.readCapabilities()) {
			driverInstanceIds.put(capabilities[0].getBrowserName(), new HashMap<String, Integer>());
		}
	}
