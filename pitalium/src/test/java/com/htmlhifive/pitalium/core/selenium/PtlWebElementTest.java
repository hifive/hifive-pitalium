...
public class PtlWebElementTest {
	...
	public void testGetDoubleOrDefault() throws Exception {
		double value = PtlWebElement.getDoubleOrDefault(1d, Double.NaN);
	...
	public void testGetDoubleOrDefault_mixed() throws Exception {
		double value = PtlWebElement.getDoubleOrDefault("1.0px", Double.NaN);
		assertThat(value, is(1d));
	}
	...
	public void testGetDoubleOrDefault_not_number() throws Exception {
		double value = PtlWebElement.getDoubleOrDefault("middle", Double.NaN);
	...
	public void testGetDoubleOrDefault_minus_number() throws Exception {
		double value = PtlWebElement.getDoubleOrDefault("-1.5px", Double.NaN);
