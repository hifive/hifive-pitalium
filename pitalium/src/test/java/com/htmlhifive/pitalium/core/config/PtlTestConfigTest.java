...
public class PtlTestConfigTest {
	...
	public void testConvertFromString_string() throws Exception {
		...
		Object result = PtlTestConfig.convertFromString(type, value);
	...
	public void testConvertFromString_enum_fail() throws Exception {
		...
		String value = "HOGE";
		Class type = RetentionPolicy.class;
		PtlTestConfig.convertFromString(type, value);
	}
	...
	public void testLoadConfig() throws Exception {
		...
		PtlTestConfig config = new PtlTestConfig(map);
	...
	static class ConfigParent {
		...
		@PtlConfigurationProperty("prop_0")
		String prop0 = "prop0";
	...
	static class ConfigChild {
		...
		@PtlConfigurationProperty("prop_1")
		String prop1 = "prop1";
		int prop2 = 10;
	...
	public void testGetEnvironment_startupArguments() throws Exception {
		Map<String, String> map = new HashMap<String, String>();
		map.put("environmentConfig", "com/htmlhifive/pitalium/core/config/PtlTestConfigTest_Env.json");
