...
/**
 * <p>
 * {@link org.junit.runners.Parameterized}テストにおいて、各パラメーター毎に全てのメソッドが始まる前に一度だけ呼ばれるメソッドを指定します。
 * </p>
 * 以下のサンプルのように利用してください。
 * 
 * <pre>
 ...
 *     public static void parameterizedBeforeClass(<b>String param1, int param2</b>) {
 * 
 *     }
 * 
 * }
