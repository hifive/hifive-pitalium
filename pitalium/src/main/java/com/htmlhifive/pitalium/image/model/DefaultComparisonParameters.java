 ...
 */
public class DefaultComparisonParameters {
	...
	public static void setSubpixelRateThreshold(double subpixelRateThreshold) {
		DefaultComparisonParameters.subpixelRateThreshold = subpixelRateThreshold;
	}
	...
	public static void setSubpixelPerLineThreshold(double subpixelPerLineThreshold) {
		DefaultComparisonParameters.subpixelPerLineThreshold = subpixelPerLineThreshold;
	}
